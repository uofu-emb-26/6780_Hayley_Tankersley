...
void My_HAL_GPIO_Init(GPIO_TypeDef  *GPIOx) /*, GPIO_InitTypeDef *GPIO_Init */
{
    ...
    assert(GPIOA->MODER == 0b00000000000000000000000000000000);

    GPIOA->OSPEEDR |= 0b00000000000000000000000000000000;
    assert(GPIOA->OSPEEDR == 0b00000000000000000000000000000000);

    GPIOA->PUPDR |= 0b00000000000000000000000000000010;
    assert(GPIOA->PUPDR == 0b00000000000000000000000000000010);
